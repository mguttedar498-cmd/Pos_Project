...
builder.Services.AddScoped<ICCAvenueQRDevice_Repository, CCAvenueQRDevice_DAL>();
builder.Services.AddScoped<IProductLicence_Repository, ProductLicence_DAL>();
builder.Services.AddScoped<IMSIC_Repository, MSIC_DAL>();
builder.Services.AddScoped<IInventoryMaster_Repository, InventoryMasterDAL>();
builder.Services.AddScoped<IInventoryPurchase_Repository, InventoryPurchaseDAL>();
// DALs
...
builder.Services.AddScoped<CCAvenueQRDevice_DAL>();
builder.Services.AddScoped<ProductLicence_DAL>();
builder.Services.AddScoped<MSIC_DAL>();
builder.Services.AddScoped<InventoryMasterDAL>();
builder.Services.AddScoped<InventoryPurchaseDAL>();
...
builder.Services.AddScoped<IInventoryPurchaseService, InventoryPurchaseService>();
// appcongifuration
